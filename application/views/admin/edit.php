    ...
    <form class="well form-horizontal" action="" method="post">
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="username" name="username" class="input-xlarge" placeholder="user name" value="<?php echo $user->username?>">
                </div>
            </div>
            <div class="control-group">
                ...
                <?php foreach ($roles as $role): ?>
                    ...
                    <div class="controls">
                        <label class="checkbox">
                            <input type="checkbox" name="role[]" value="<?php echo $role->id?>" <?php echo in_array($role->id, $userRole)? 'checked="checked"': '' ?> id="rolescheckboxs">
