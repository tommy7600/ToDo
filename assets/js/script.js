...
jQuery(function($) {
  ...
  /* ------- Top Menu - Search Box ------- */
    ...
    // $('#nav_collapse_btn').click(function() {
    //   $('.nav-collapse').slideToggle(1000,"easeOutBounce");
    // });
  ...
  /* ------- Widget Toggle ------- */
    ...
    */
    ...
    //   alert(current_link);
    //   link_bg_text = current_link.text();
    //   $.jStorage.set("site_bg", link_bg_text;

    //   $('body').addClass(current_link.text());
...
function sidebarHeightCheck(){
  ...
  //alert(side_nav_height +" - "+ window_height +" - "+ minus_pocent +" - "+ window_height_minus_pocent);
